/*
===========================================================================
Description: This is a solver for SIP
Version: 1.0
Created: 2022.8.1
Revision: none
Compiler: g++
Author: Yiyuan Wang     yiyuanwangjlu@126.com
              Chenghou Jin    jinchenghou1123@126.com
              Shaowei Cai     caisw@ios.ac.cn
              Qingwei Lin     qlin@microsoft.com
For example: ./PathLAD+ -p pattern.txt -t target.txt -f -s <time limit>
===========================================================================
*/
